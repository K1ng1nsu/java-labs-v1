...
public class LambdaLab {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> multipleOfThree = numbers.stream().filter(i -> i % 3 == 0).toList();
        ...
        System.out.println(add.calculateAndFormat(2,3));
        System.out.println(subtract.calculateAndFormat(2,3));
        System.out.println(multiply.calculateAndFormat(2,3));
        System.out.println(divide.calculateAndFormat(2,3));
    }
