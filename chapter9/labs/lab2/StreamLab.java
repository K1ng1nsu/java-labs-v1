...
public class StreamLab {
    ...
    public static void main(String[] args) {
        ...
        List<String> cities = Arrays.asList("서울1", "부산", "인천", "대구2", "대전", "광주", "울산3", "세종");
        // 힌트: cities.stream()...
        ...
        cities.stream().filter(s -> s.length() >= 3).forEach(s -> {
        ...
        Map<Integer, Optional<Student>> topScoreByGrade = students.stream().collect(Collectors.groupingBy(Student::getGrade, Collectors.maxBy((o1, o2) -> Integer.compare(o1.getScore(), o2.getScore()))));


        System.out.println(topScoreByGrade);
        ...
        Map<String, Long> wordsCount = Arrays.stream(text.split(" ")).collect(Collectors.groupingBy(s -> s, Collectors.counting()));
