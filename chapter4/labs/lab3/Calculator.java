...
public class Calculator {
    ...
    String model;
    int countOfCalculation;
    
    // TODO: 계산기 객체의 총 개수를 나타내는 static 변수를 정의하세요.
    static int numberOfCalculator;
    ...
    public void increaseCountOfCalculation() {
        countOfCalculation++;
    }
    ...
    public String toString() {
        return "Calculator{" +
                "model='" + model + '\'' +
                ", countOfCalculation=" + countOfCalculation +
                '}';
    }


    // TODO: 현재까지 생성된 계산기의 총 개수를 반환하는 static 메소드를 정의하세요.
    public static int getNumberOfCalculator() {
        return numberOfCalculator;
    }
